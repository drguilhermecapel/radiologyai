"""Plugin de CT — declarado, sem modelo treinado ou validado.
...
class CTPlugin(UnimplementedModality):
    """CT — pendente das fases descritas em ROADMAP.md §5."""

    code: ClassVar[str] = "CT"
    accepted_modalities: ClassVar[frozenset[str]] = frozenset({"CT"})
