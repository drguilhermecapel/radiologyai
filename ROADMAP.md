...
**Pinos:** `torch==2.5.1`, `monai==1.4.0`, `torchxrayvision==1.3.4`, `timm`, `pydicom==2.4.4` (2.x — a 3.x mudou a API de pixel handlers), `SimpleITK==2.4.x`, `onnxruntime==1.20.x`, Python `>=3.11,<3.12`. Lockfile com `uv`. Cada versão entra literalmente na lista SOUP.
